    ...
    <>
        <div className="w-full p-8 md:w-1/2 lg:w-1/3      shadow-xl">
            <div className="flex items-center mb-6">
                <svg onClick={() => updateHandler(id)} style={{cursor:"pointer"}}  width="20" height="20" fill="currentColor" className="w-6 h-6 text-indigo-500" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <button  onClick={() => updateHandler(id, title, description)} className="text-white text-base  py-1 px-3 bg-sky-500 hover:bg-sky-700 rounded">Update</button>
        </div>
